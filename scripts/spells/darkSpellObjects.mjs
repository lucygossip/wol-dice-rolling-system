class darkSpell {
  ...
  const darkSpells = [
    ...
    new darkSpell("(To be named)", 8, "dark", "The caster pays a toll of 10hp, in exchange for casting 30 damage at the opponent. If the caster misses, they still have to pay this toll."),
    new darkSpell("(To be named", 8, "dark", "The effects of the opponent's status weapon are removed for the duration of the turn. Ivella Ro Cinys is immune"),
